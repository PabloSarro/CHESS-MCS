...
#include <DeploymentSim/Top/DeploymentSimTopology.hpp>
// OSAL initialization
#include <Os/Os.hpp>
...
int main(int argc, char* argv[]) {
    ...
    DeploymentSim::TopologyState inputs;
    ...
    DeploymentSim::setupTopology(inputs);
    DeploymentSim::startRateGroups(Fw::TimeInterval(1,0));  // Program loop cycling rate groups at 1Hz
    DeploymentSim::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
